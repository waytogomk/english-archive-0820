    ...
    <main>
      ...
      <section className="dashboard-row">
        ...
        <article className="fridge-preview">
          <div><span className="fridge-card-title">Teacher&apos;s Treat Fridge</span><h2 className="fridge-slogan">Study Hard,<br />Snack Smart</h2><p className="reward-coupon"><strong>1</strong><span>쿠폰</span></p><Link className="button button-dark" href="/treat-fridge">Open</Link></div>
